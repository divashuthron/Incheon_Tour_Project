...
<body>
  ...
  <hr>
    ...
    <div class="textform">
    <form action="NoticeManagementUpProc.jsp" method="post">
    <label for="field1"><span>제목 <span class="required"></span></span><input type="text" class="input-field" name="NNA" value="<%= NTB.getNNA() %>" /></label>
    <label for="field2"><span>작성자 <span class="required"></span></span><input type="text" class="input-field" name="NA" value="<%= NTB.getNA() %>" /></label>
    <label for="field3"><span>작성일<span class = "required"></span></span><input type="text" class="input-field" name=DATE value="<%= NTB.getDATE() %>"></label>
    <label for="field4"><span>글 내용 <span class="required">*</span></span><textarea name="CONTENT" class="textarea-field" style="resize: none;"><%= NTB.getCONTENT() %></textarea></label>
   	<input type = "hidden" name = "NUM" value = "<%= NTB.getNUM() %>">
